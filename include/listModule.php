<?php 
$idAsDelete;
$sql = "SELECT * FROM module ORDER BY numero_module";
    ...
    <form action="index.php" method="POST">
        <div class="card text-white bg-primary " style="max-width:40rem;">
            ...
            <div class="card-body bg-secondary">
                <h5 class="card-title"> n° <input hidden readonly type="text" class="bg-primary border-hidden"
                        value="<?php echo $row['numero_module'];?>" name="numero_module">
                    <?php echo $row['numero_module'];?> </h5>
                ...
                <p class="card-text">Date de debut de service: <?php echo $dateStart;?></p>
                <p class="card-text">Date de finde service : <?php echo $dateEnd;?></p>
                <p class="card-text">Description : <br> <?php echo $row['description_module'];?></p>
            </div>
